...
nodes = pd.read_csv('../../../../gedcoms/temp/test_pyvis_nodes_export.csv', na_filter=False)
print('Read edges CSV file')
edges = pd.read_csv('../../../../gedcoms/temp/test_pyvis_edges_export.csv', na_filter=False)
...
node_data = zip(node_ids, node_labels, node_titles, node_colors, node_sizes)
...
for node in node_data:
    ...
    net.add_node(id, label=label, title=title, color=color, size=size)
