...
public class AdminControllerIT extends AbstractControllerIT {
    ...
    public void testAnalyzeGedcom() throws Exception {
        ...
        mvc.perform(multipart(HttpMethod.POST, "/api/admin/gedcom-analyzer")
                        .file(multipartFile)
                        .with(csrf()))
    ...
    public void testUsageStats() throws Exception {
        String url = "/api/admin/gedcom-analyzer/usageStats";
        ...
        url = "/api/admin/gedcom-analyzer/usageStats";
        result = mvc.perform(get(url).with(csrf()))
                .andExpect(status().isOk())
